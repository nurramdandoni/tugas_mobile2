...
$routes->resource('tahun_ajaran');
$routes->resource('guru');
$routes->resource('siswa');
$routes->resource('jurusan');
$routes->resource('hari');
$routes->resource('pelajaran');
$routes->resource('user');
$routes->resource('kelas');
$routes->resource('kurikulum');
$routes->resource('kartu_rencana_studi');
$routes->resource('kartu_rencana_studi_detail');
